...
export default function GameHUD({
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10">
      ...
      {/* 小地图 - 手机上隐藏以节省空间 */}
      <div className={`absolute top-20 right-4 pointer-events-auto ${isTouchDevice ? 'hidden sm:block' : ''}`}>
      ...
      {/* 区域提示 */}
      <div className={`absolute bottom-4 ${isTouchDevice ? 'left-1/2 -translate-x-1/2' : 'left-4'}`}>
